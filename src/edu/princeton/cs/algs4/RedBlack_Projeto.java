...
public class RedBlack_Projeto<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) { 
        RedBlack_Projeto<String, Integer> st = new RedBlack_Projeto<String, Integer>();
